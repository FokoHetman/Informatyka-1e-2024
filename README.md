...
4. Run: ```firefox 127.0.0.1:2137``` in new terminal (!! Change firefox to browser you use !!)
...
4. Użyj komendy: ```firefox 127.0.0.1:2137``` w nowym oknie terminalu (!! Zmień firefox na używaną przez ciebie przeglądarkę !!) lub wpisz URL `127.0.0.1:5000` w przeglądarce.
